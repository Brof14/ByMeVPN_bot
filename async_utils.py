...
_db_semaphore = asyncio.Semaphore(20)  # Increased to 20 for better DB concurrency
_xui_semaphore = asyncio.Semaphore(15)   # Increased to 15 for better API concurrency

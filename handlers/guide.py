...
_GUIDES: dict[str, str] = {
    "ios": (
        ...
        "<b>1. Скачайте HAPP</b>\n"
        "RU: App Store → <a href='https://apps.apple.com/ru/app/happ-proxy-utility-plus/id6746188973'>HAPP Proxy Utility Plus</a>\n"
        "US: App Store (если первая ссылка недоступна) → <a href='https://apps.apple.com/us/app/happ-proxy-utility/id6504287215'>HAPP Proxy Utility</a>\n\n"
        "<b>2. Скопируйте ключ</b>\n"
        "Нажмите на ссылку, выданную в боте (подписку)\n\n"
        "<b>3. Откройте приложение</b>\n"
        "Нажмите «Вставить из буфера» в левом нижнем углу\n\n"
        "<b>4. Подключитесь</b>\n"
        "Включите переключатель большой по центру — готово!\n\n"
